...
function get (type, tonic) {
  ...
  return ivls ? tonalHarmonizer.harmonize(ivls, tonic) : <span class="branch-1 cbranch-no" title="branch not covered" >null</span>
}
&nbsp;
/**
...
function position (chord) {
  ...
  return sorted ? sorted.indexOf(pcs[0]) : <span class="branch-1 cbranch-no" title="branch not covered" >null</span>
}
&nbsp;
/**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Aug 07 2017 02:23:24 GMT+0200 (CEST)
</div>
</div>
