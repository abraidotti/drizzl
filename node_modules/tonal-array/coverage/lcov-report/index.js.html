...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { midi, name } from "tonal-note";
&nbsp;
// ascending range
function ascR(b, n) {
  for (var a = []; n--; a[n] = n + b);
 ...
 */
export var shuffle = (arr, rnd = <span class="branch-0 cbranch-no" title="branch not covered" >Math.random)</span> =&gt; {
  var i, t;
  var m = arr.length;
  while (m) {
    i = (rnd() * m--) | 0;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Sep 29 2017 13:33:51 GMT+0200 (CEST)
</div>
</div>
